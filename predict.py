...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = r"F:\deeplearning\program\UNet\VOCdevkit\VOC2007_7000+\JPEGImages\\"
    dir_save_path   = r"F:\deeplearning\program\UNet\VOCdevkit\VOC2007_7000+\gray\\"
    #-------------------------------------------------------------------------#
    ...
    ## 下面是检测电脑自带摄像头的
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(('.bmp', '.dib', '.png', '.jpg', '.jpeg', '.pbm', '.pgm', '.ppm', '.tif', '.tiff')):
                ...
                r_image.save(os.path.join(dir_save_path, os.path.splitext(img_name)[0] + '.png'))
                #有损压缩jpg
