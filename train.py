...
from nets.pure_unet import UNet
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path  = r".\model_data\unet_carvana_scale1.0_epoch2.pth"
    # ---------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = 'pretrain+pure_unet+512x512_logs'
    #------------------------------------------------------------------#
    ...
    if True:
        ...
        #----------------------#
        if local_rank == 0:
            eval_callback   = EvalCallback(model, input_shape, num_classes, classes_name, val_lines, VOCdevkit_path, log_dir, Cuda,
